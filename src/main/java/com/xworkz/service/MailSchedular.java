...
public class MailSchedular {
	...
	public List<Subscriber> getListOfSubscribersFromExcel() {
		...
		try {
			int i = 0;
			URL url = new URL("https://github.com/vinay-coder1/thor/raw/master/xworkz.xlsx");
			...
			if (responseCode == HttpURLConnection.HTTP_OK) {
				...
				for (Row row : excelSheet) { // For each Row.
					...
					subscribersList.add(new Subscriber(nameCell.getStringCellValue(), emailCell.getStringCellValue(),
